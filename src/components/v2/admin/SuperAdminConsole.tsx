    ...
    <div data-super-admin-console className="min-h-screen bg-[#eef1ef] text-[#19221e]">
      ...
      <div className="grid min-h-screen lg:grid-cols-[224px_minmax(0,1fr)]">
        <aside className="border-r border-[#dbe0dc] bg-[#17211d] p-4 text-white">
          ...
          <div className="mt-6 border-t border-white/10 pt-5"><Link href="/v2/support" className="flex items-center gap-3 rounded-md px-3 py-3 text-xs font-bold text-white/70 hover:bg-white/8"><Bot size={17} />Open Angel</Link></div>
