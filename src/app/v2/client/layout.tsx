...
export default async function Layout({children}:{children:React.ReactNode}){const {profile}=await requireDashboardRole("customer");return <ClientShell initialProfile={profile}>{children}</ClientShell>}
