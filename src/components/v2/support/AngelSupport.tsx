...
export function AngelSupport() {
  ...
  return (
    <div className="min-h-[calc(100vh-70px)] bg-[#f3f5f3]">
      <header className="border-b border-[#dfe4e0] bg-white px-5 py-4 sm:px-8">
        <div className="mx-auto flex max-w-[1500px] flex-wrap items-end justify-between gap-4">
          <div><p className="text-[10px] font-extrabold uppercase tracking-[0.15em] text-[#d65f45]">SAIOS support</p><h1 className="mt-1 text-2xl font-extrabold text-[#1c2723]">Angel AI</h1><p className="mt-1 max-w-2xl text-xs leading-5 text-[#68716d]">Short, specific answers grounded in Sajivo's approved knowledge and your account.</p></div>
      ...
      <div className="mx-auto grid h-[min(680px,calc(100vh-150px))] min-h-[520px] max-w-[1320px] gap-px bg-[#dfe4e0] lg:grid-cols-[230px_minmax(0,1fr)_260px]">
        ...
        <section className="flex min-h-0 min-w-0 flex-col bg-[#f8f9f8]">
